...
percent_Ni = np.array([0.0, 50.0, 75.0, 100.0])

latticeParam = np.array([3.6164, 3.5650, 3.5446, 3.5253])

latticeParamError = np.array([0.0003, 0.0005,0.0004, 0.0003])
...
#
f.set_functions(' a*(1-(x/100.0)) + b*(x/100.0) ',' a=3.6164, b= 3.5253, z=1')
